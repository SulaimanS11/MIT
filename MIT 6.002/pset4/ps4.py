...
### Begining of program
raw_data = Climate('P\MIT\MIT 6.002\pset4\data.csv')
...
yo, estyo = evaluate_models_on_training(x, y, models)
# print(yo, estyo)
print(r_squared(yo, estyo))
...
bob = Climate("P\MIT\MIT 6.002\pset4\data.csv")
...
yo, estyo = evaluate_models_on_training(x1, y, models)
print(r_squared(yo, estyo))
